...
add_fileset_file clock_gen.vhd VHDL PATH ../../hdl/led-patterns/clock_gen.vhd
add_fileset_file pat_gen_0.vhd VHDL PATH ../../hdl/led-patterns/pat_gen_0.vhd
add_fileset_file pat_gen_1.vhd VHDL PATH ../../hdl/led-patterns/pat_gen_1.vhd
add_fileset_file pat_gen_2.vhd VHDL PATH ../../hdl/led-patterns/pat_gen_2.vhd
add_fileset_file pat_gen_3.vhd VHDL PATH ../../hdl/led-patterns/pat_gen_3.vhd
add_fileset_file pat_gen_4.vhd VHDL PATH ../../hdl/led-patterns/pat_gen_4.vhd
...
set_interface_property avalon_slave_0 associatedClock clk_interface
set_interface_property avalon_slave_0 associatedReset reset_interface
...
# 
# connection point clk_interface
# 
...
set_interface_property clk_interface EXPORT_OF ""
set_interface_property clk_interface PORT_NAME_MAP ""
set_interface_property clk_interface CMSIS_SVD_VARIABLES ""
set_interface_property clk_interface SVD_ADDRESS_GROUP ""

add_interface_port clk_interface clk clk Input 1
...
set_interface_property reset_interface associatedClock clk_interface
...
add_interface_port reset_interface rst reset Input 1
...
set_interface_property export associatedClock clk_interface
